...
# Fit df to south
minke.df.S.strat <- ds(minke.S, key="hr", adjustment=NULL, 
                       truncation=minke.trunc)
# Print results
...
```{r, echo=T, eval=F}
dht2(ddf=minke.df.all, flatfile=minke, strat_formula=~Region.Label,
...
```{r, echo=T, eval=F}
dht2(ddf=minke.df.all, flatfile=minke, strat_formula=~1, 
     stratification="geographical")
```
