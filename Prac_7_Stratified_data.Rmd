...
+ `convert_units`
  - getting units conversion correct, same purpose as the `convert.units` argument in `ds`.  For the minke data all measurements are in the same units, so the argument is not needed in this case.
